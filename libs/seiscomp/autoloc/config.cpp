...
void Config::dump() const
{
	...
	if(gridConfigFile.empty())
		SEISCOMP_INFO("  grid not specified!");
	else
		SEISCOMP_INFO("  grid                   %s",      gridConfigFile.c_str());
...
//	SEISCOMP_INFO("  minStaCountIgnorePKP             %d",     minStaCountIgnorePKP);
	...
	SEISCOMP_INFO("  pickLogEnable                    %s",     pickLogEnable ? "true":"false");
